...
do for [i=startRN:endRN:RNinterval] {

datafile1='PONTA_exp'.sprintf("%04d",expNo).'_scan'.sprintf("%04d",i).'.dat'


#for png
set term png
set out 'PONTA_exp'.sprintf("%04d",expNo).'_scan'.sprintf("%04d",i).'.png'
...
plot datafile1 u 2:5:(sqrt($5)) w yer ls 1 not
